...
const SECRETS = require('../../cloudfunctions/config/secrets.json');
const AUTH0_CLIENT_ID = SECRETS.AUTH0_CLIENT_ID;
const AUTH0_DOMAIN = 'dev-kg5-6f-1.eu.auth0.com';
...
const PRIVATE_ENDPOINT = 'https://h0bcqs9rmd.execute-api.eu-west-2.amazonaws.com/dev/api/profile/update';
